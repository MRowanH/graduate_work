...
class Ui_Login(object):
    ...
    def retranslateUi(self, Login):
        ...
        self.signIn_button.setText(QCoreApplication.translate("Login", u"Sign In", None))
        self.label_3.setText(QCoreApplication.translate("Login", u"<html><head/><body><p align=\"center\">Password</p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Login", u"<html><head/><body><p align=\"center\">Username</p></body></html>", None))
        self.label.setText(QCoreApplication.translate("Login", u"Login", None))
        self.pushButton.setText(QCoreApplication.translate("Login", u"Logout", None))
    # retranslateUi
