from PySide6.QtWidgets import QWidget, QListWidgetItem, QListWidget, QTextBrowser, QCheckBox, QGroupBox, QVBoxLayout
from ui.ui_PublicRecipes import Ui_PublicRecipesWidget
from common import *

class PublicRecipes(QWidget, Ui_PublicRecipesWidget):
    ...
    # Initilizes pubilc recipes
    def init_public_recipes_list(self):
    ...
    def recipe_clicked(self, item):
        ...
        # adjust the checkbox according if it is in the meal plan
